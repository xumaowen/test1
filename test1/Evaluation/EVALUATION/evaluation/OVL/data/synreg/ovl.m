...
a=reshape(atlas_ovl,1,1048576);
a=nonzeros(a);
b=reshape(dtitk_ovl,1,1048576);
b=nonzeros(b);
c=reshape(W_ovl,1,1048576);
c=nonzeros(c);
d=reshape(IIT_ovl,1,16777216);
d=nonzeros(d);
e=reshape(NTU_ovl,1,16777216);
e=nonzeros(e);
...
xlabel('Average Overlap of WM eigenvalue-eigenvector pairs OVL');
