...
%[filename pathname]=uigetfile('*.nii');
template_l1=load_nii('NTU-122_L1.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_l2=load_nii('NTU-122_L2.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_l3=load_nii('NTU-122_L3.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_v1=load_nii('NTU-122_V1.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_v2=load_nii('NTU-122_V2.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_v3=load_nii('NTU-122_V3.nii.gz',[],1);
...
NTU_ovl=(dtitk_s1_ovl+dtitk_s2_ovl+dtitk_s3_ovl+dtitk_s4_ovl+dtitk_s5_ovl+...
    dtitk_s6_ovl+dtitk_s7_ovl+dtitk_s8_ovl+dtitk_s9_ovl+dtitk_s10_ovl)/10;

save NTU_ovl NTU_ovl;
