...
%[filename pathname]=uigetfile('*.nii');
template_l1=load_nii('W-average_L1.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_l2=load_nii('W-average_L2.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_l3=load_nii('W-average_L3.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_v1=load_nii('W-average_V1.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_v2=load_nii('W-average_V2.nii.gz',[],1);
%[filename pathname]=uigetfile('*.nii');
template_v3=load_nii('W-average_V3.nii.gz',[],1);
...
W_ovl=(dtitk_s1_ovl+dtitk_s2_ovl+dtitk_s3_ovl+dtitk_s4_ovl+dtitk_s5_ovl+...
