...
a=reshape(atlas2_alpha3,1,1048576);
a=nonzeros(a);
b=reshape(dtitk_alpha3,1,1048576);
b=nonzeros(b);
c=reshape(W_alpha3,1,1048576);
c=nonzeros(c);
d=reshape(IIT_alpha3,1,16777216);
d=nonzeros(d);
e=reshape(NTU_alpha3,1,16777216);
e=nonzeros(e);
