...
S0=corrcoef(s0,tem); % 计算template纤维束与052纤维束之间的相关系数
S1=corrcoef(s1,tem);
S2=corrcoef(s2,tem);
S3=corrcoef(s3,tem);
S4=corrcoef(s4,tem);
...
% RES=[Me Sd Corr(2,1)];
% RE=RES';
Cor=[S0(2,1) S1(2,1) S2(2,1) S3(2,1) S4(2,1) S5(2,1) S6(2,1) S7(2,1) S8(2,1) S9(2,1)] % 获得template纤维束与052,083,328,...,439等10个受试者纤维束之间的相关系数