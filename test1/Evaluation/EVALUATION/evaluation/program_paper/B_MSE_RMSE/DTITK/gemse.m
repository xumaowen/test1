clear all;
clc;
sub052=importdata('Genu/dtitk052_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub052_tensor=sub052(7977:25654,:);
sub083=importdata('Genu/dtitk083_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub083_tensor=sub083(7977:25654,:);
sub328=importdata('Genu/dtitk328_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub328_tensor=sub328(7977:25654,:);
sub329=importdata('Genu/dtitk329_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub329_tensor=sub329(7977:25654,:);
sub354=importdata('Genu/dtitk354_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub354_tensor=sub354(7977:25654,:);
sub383=importdata('Genu/dtitk383_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub383_tensor=sub383(7977:25654,:);
sub386=importdata('Genu/dtitk386_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub386_tensor=sub386(7977:25654,:);
sub396=importdata('Genu/dtitk396_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub396_tensor=sub396(7977:25654,:);
sub438=importdata('Genu/dtitk438_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub438_tensor=sub438(7977:25654,:);
sub439=importdata('Genu/dtitk439_genue corpus callosum Fiber Bundle_fa__Clean.txt');
