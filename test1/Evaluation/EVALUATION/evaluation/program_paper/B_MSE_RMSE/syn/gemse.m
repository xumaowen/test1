clear all;
clc;
sub052=importdata('Genu/syn052_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub052_tensor=sub052(7977:25654,:);
sub083=importdata('Genu/syn083_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub083_tensor=sub083(7977:25654,:);
sub328=importdata('Genu/syn328_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub328_tensor=sub328(7977:25654,:);
sub329=importdata('Genu/syn329_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub329_tensor=sub329(7977:25654,:);
sub354=importdata('Genu/syn354_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub354_tensor=sub354(7977:25654,:);
sub383=importdata('Genu/syn383_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub383_tensor=sub383(7977:25654,:);
sub386=importdata('Genu/syn386_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub386_tensor=sub386(7977:25654,:);
sub396=importdata('Genu/syn396_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub396_tensor=sub396(7977:25654,:);
sub438=importdata('Genu/syn438_genue corpus callosum Fiber Bundle_fa__Clean.txt');
sub438_tensor=sub438(7977:25654,:);
sub439=importdata('Genu/syn439_genue corpus callosum Fiber Bundle_fa__Clean.txt');
