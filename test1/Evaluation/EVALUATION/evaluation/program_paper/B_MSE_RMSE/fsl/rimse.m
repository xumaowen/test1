clear all;
clc;
sub052=importdata('R-IFO/sub052_right-fiber-IFO_fa__Clean.txt');
sub052_tensor=sub052(16839:54297,:);
sub083=importdata('R-IFO/sub083_right-fiber-IFO_fa__Clean.txt');
sub083_tensor=sub083(16839:54297,:);
sub328=importdata('R-IFO/sub328_right-fiber-IFO_fa__Clean.txt');
sub328_tensor=sub328(16839:54297,:);
sub329=importdata('R-IFO/sub329_right-fiber-IFO_fa__Clean.txt');
sub329_tensor=sub329(16839:54297,:);
sub354=importdata('R-IFO/sub354_right-fiber-IFO_fa__Clean.txt');
sub354_tensor=sub354(16839:54297,:);
sub383=importdata('R-IFO/sub383_right-fiber-IFO_fa__Clean.txt');
sub383_tensor=sub383(16839:54297,:);
sub386=importdata('R-IFO/sub386_right-fiber-IFO_fa__Clean.txt');
sub386_tensor=sub386(16839:54297,:);
sub396=importdata('R-IFO/sub396_right-fiber-IFO_fa__Clean.txt');
sub396_tensor=sub396(16839:54297,:);
sub438=importdata('R-IFO/sub438_right-fiber-IFO_fa__Clean.txt');
sub438_tensor=sub438(16839:54297,:);
sub439=importdata('R-IFO/sub439_right-fiber-IFO_fa__Clean.txt');
