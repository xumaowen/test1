...
fid_sub_052 = fopen([pathname filename]);%%fopen  subject_052 FiberSplenium.dat
sub_052 = fread(fid_sub_052);

[filename pathname]=uigetfile('*.dat');
fid_tem_052 = fopen([pathname filename]);%%fopen  template_FiberSplenium.dat
template_052 = fread(fid_tem_052);

[filename pathname]=uigetfile('*.dat');
fid_sub_083 = fopen([pathname filename]);%%fopen  subject_083 FiberSplenium.dat
sub_083 = fread(fid_sub_083);
[filename pathname]=uigetfile('*.dat');
fid_tem_083 =  fopen([pathname filename]);%%fopen  template_FiberSplenium.dat,ÏÂÍ¬
...
d_439=HausdorffDist(air_F_data_439,template_G_data_439);
 ...
 d_air_ave=(d_air_052+d_air_083+d_air_328+d_air_329+d_air_354+...
     +d_air_383+d_air_386+d_air_396+d_air_438+d_air_439)/10
