...
fid_sub_052 = fopen([pathname filename]);%%fopen  subject_052 FiberR-CST.dat
sub_052 = fread(fid_sub_052);

[filename pathname]=uigetfile('*.dat');
fid_tem_052 = fopen([pathname filename]);%%fopen  template_FiberR-CST.dat
template_052 = fread(fid_tem_052);

[filename pathname]=uigetfile('*.dat');
fid_sub_083 = fopen([pathname filename]);%%fopen  subject_083 FiberR-CST.dat
sub_083 = fread(fid_sub_083);
[filename pathname]=uigetfile('*.dat');
fid_tem_083 =  fopen([pathname filename]);%%fopen  template_FiberR-CST.dat,ÏÂÍ¬
